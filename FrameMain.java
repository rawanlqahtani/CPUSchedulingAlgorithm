...
public class FrameMain
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == _btn_save) {
            ...
            refreshDetails();
            JOptionPane.showMessageDialog(null, "Process # " + (index + 1) + " Saved",
        ...
        if (e.getSource() == _btn_delete) {
            ...
            _jobs.remove(index);
            refreshList();
            JOptionPane.showMessageDialog(null, "Process " + (index + 1) + " Deleted",
